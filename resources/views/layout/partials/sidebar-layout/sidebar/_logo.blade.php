...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="{{ route('dashboard') }}">
		<img alt="Logo" src="/registerAndLogin/Logo1.png" class="h-25px app-sidebar-logo-default" />
		<img alt="Logo" src="/registerAndLogin/Logo2.png" class="h-20px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
